...
static void init_device(void)
{
        ...
        if (force_format) {
                ...
                fmt.fmt.pix.pixelformat = V4L2_PIX_FMT_RGB332; // NOTE: change this to change the forced format. see videodev2.h for all format options
